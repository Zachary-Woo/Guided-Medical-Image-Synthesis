...
def load_synthetic_data(synthetic_data_dir, task, transform, mask_transform=None, synthetic_mask_folder=None):
    """
...
def main():
    ...
    medmnist_dataset_name = config.data.dataset_name
    ...
    info = INFO[medmnist_dataset_name.lower()]
    ...
    if task == "segmentation":
         if medmnist_dataset_name not in ["OrganAMNIST", "OrganCMNIST", "OrganSMNIST"]:
